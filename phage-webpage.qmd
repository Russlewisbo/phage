...
subtitle: "Lecture notes — companion to the slide deck"
...
These notes follow the slide deck section by section, providing the depth and references behind each slide. They are pitched for advanced trainees (ID fellows) and assume familiarity with resistance mechanisms, PK/PD, and clinical-trial interpretation. The companion deck is `phage-slides.qmd`. Primary source for the phage/endolysin/AMP content is the Mandell chapter by Doub, Suh, and Chan; the monoclonal antibody section is added from the primary trial literature.
:::
...
::: {.callout-tip}
## Teaching anchor
Return to @tbl-platforms throughout. The intellectual payoff of the lecture is recognising that each agent's clinical niche follows directly from its pharmacology — self-amplification, replication status, and mechanism of bacterial killing or neutralization.
:::
...
<!-- IMAGE NEEDED: labelled tailed-phage diagram (capsid head, contractile sheath, baseplate, tail fibres) -->
